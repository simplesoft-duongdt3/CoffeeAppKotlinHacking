...
import com.coffeetek.todo.location.exception.SettingsFusedLocationException
import com.coffeetek.todo.location.rxfusedlocation.LocationSettingsActivity
...
class SettingsFusedLocationSingleOnSubscribe(
                ...
                .addOnFailureListener {
                    ...
                    when (statusCode) {
                        LocationSettingsStatusCodes.RESOLUTION_REQUIRED -> {
                            ...
                            observableMap[observableId] = WeakReference(this@SettingsFusedLocationSingleOnSubscribe)
    ...
    companion object {
        private val observableMap = HashMap<String, WeakReference<SettingsFusedLocationSingleOnSubscribe>>()
